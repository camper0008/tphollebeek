...
import dtImage from '../assets/images/dt-explained.apng';
    ...
    return (
        <section className="section">
          ...
          <h2>FirmaCorp Site</h2>
            ...
            <p>Sammen med min klassekammerat <a href="https://simonfromjakobsen.netlify.app" target="_blank" rel="noreferrer">Simon</a> lavede vi en hjemmeside med en startside med karrusel af forskellige produkter, produktliste og produktside, samt et Intra for at skabe og slette nye produkter og opdatere karrusellen.</p>
          ...
          <h2>DataTech Projekt</h2>
            <p>Fordi vi kedede os, valgte <a href="https://simonfromjakobsen.netlify.app" target="_blank" rel="noreferrer">Simon</a> og jeg at lave en side vi forklarede som "en social media platform til projekter, fx praktikplads søgende datateknikere".</p>
            <p>For at prøve noget anderledes end hvad vi normalt gjorde, ville jeg arbejde på backend mens Simon arbejdede på frontend.</p>
            <p>Vi arbejdede på det, men evt. fik jeg pludselig en god idé til vores frontend design og lavede adskillige drafts derudaf, som er de designs der kan ses nedenunder.</p>
            <p>Selv om "jeg" har lavet designet, kommer meget af layout og farvevalg fra <a href="https://simonfromjakobsen.netlify.app" target="_blank" rel="noreferrer">Simon</a>.</p>
            <p>Nuværende arbejder vi på at implementere blog editoren.</p>
